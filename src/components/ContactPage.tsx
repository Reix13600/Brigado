...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans flex flex-col">
      <div className="max-w-lg mx-auto px-6 pt-10 pb-16 flex-1 w-full">
        ...
        {sent ? (
          <div className="bg-slate-900 border border-lime-400/30 rounded-2xl p-8 text-center space-y-3">
            <CheckCircle2 className="text-lime-400 mx-auto" size={32} />
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
            ...
            >
              <Send size={15} /> {sending ? "..." : (lang === "fr" ? "Envoyer" : "Send")}
            </button>
          </div>
        )}
      </div>
